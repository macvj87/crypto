...
st.markdown("""
This app retrieves live cryptocurrency prices for the top 10 cryptocurrency from **CoinMarketCap**!
Please play around with the Dataset.
""")
#---------------------------------#
# About
...
currency_price_unit = col1.selectbox('Select currency for price', ('USD', 'AUD', 'BTC', 'ETH'))
...
#           str(df_selected_coin.shape[0]) + ' rows and ' + str(df_selected_coin.shape[1]) + ' columns.')
